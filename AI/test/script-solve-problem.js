...
function resetAnalysis() {
    ...
    // 分析輸入 (主要函數)
    // script-solve-problem.js 中的 analyzeInput 函數
async function analyzeInput() {
    ...
    try {
        ...
        const displayedImage = imagePreviewArea ? imagePreviewArea.querySelector('img') : null;
        const imageContent = document.getElementById('imageContent');
        
        if (imageContent.classList.contains('active') && displayedImage) {
            // 從當前顯示的圖片創建新的 Canvas
