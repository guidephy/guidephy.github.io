...
async function fetchBotReply(thread) {
    try {
        ...
        const systemMessage = {
            role: 'user',
            parts: [{ text: '請以:1、善於將複雜概念轉化為簡單易懂的解釋2、會適時舉例說明，幫助理解3、喜歡引導學生思考，而不是直接給答案4、會點出重要觀念，避免冗長贅述5、以鼓勵和正向的態度回應注意事項：1、使用繁體中文回答2、回應簡潔但不失重點3、引導思考但不模糊焦點4、若遇到艱深概念，請用生活化例子說明5、適時給予延伸思考的建議現在請以這樣的角色和風格來回應問題。' }]
        };
